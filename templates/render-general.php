		...
		<thead>
			<tr class="kdna-table__row kdna-table__row--head">
				<?php for ( $c = 0; $c < $column_count; $c++ ) :
					...
					?>
					<th scope="col" class="<?php echo esc_attr( $cell_classes ); ?>" style="text-align: <?php echo esc_attr( $align ); ?>;">
						<?php
		...
		<?php foreach ( $body_rows as $row_index => $row ) :
			...
			<tr class="kdna-table__row kdna-table__row--body kdna-table__row--<?php echo ( 0 === $row_index % 2 ) ? 'odd' : 'even'; ?>">
				<?php for ( $c = 0; $c < $column_count; $c++ ) :
					...
					?>
					<<?php echo $tag; ?><?php echo $is_row_header ? ' scope="row"' : ''; ?> class="<?php echo esc_attr( $cell_classes ); ?>" style="text-align: <?php echo esc_attr( $align ); ?>;">
